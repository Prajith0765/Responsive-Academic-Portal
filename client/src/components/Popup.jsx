        ...
        <div className="fixed bottom-5 right-5">
            ...
            {isOpen && (
                <div className="absolute bottom-0 right-0 m-4">
                    <button className="absolute top-0 right-0 w-7" onClick={togglePopup}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
